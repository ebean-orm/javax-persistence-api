 ...
 * <p>
 * The methods of this interface should only be invoked on entity instances obtained from or managed by entity
 * managers for this persistence unit or on new entity instances.
 *
 * @since Java Persistence 2.0
 */
public interface PersistenceUnitUtil extends PersistenceUtil {
  /**
   * Determine the load state of a given persistent attribute of an entity belonging to the persistence
   * unit.
   *
   ...
   * @return false if entity's state has not been loaded or if the attribute state has not been loaded, else
   * true
   */
   ...
   * determine the load state of an entity passed as a reference. An entity is considered loaded if all
   * attributes for which <code>FetchType.EAGER</code> has been specified have been loaded.
   * <p>
   * The <code>isLoaded(Object, String)</code> method should be used to determine the load state of an

...
/**
 * Specifies the discriminator column for the <code>SINGLE_TABLE</code> and <code>JOINED</code>
 ...
 * <p>
 * If the <code>DiscriminatorColumn</code> annotation is missing, and a discriminator column is required, the
 * name of the discriminator column defaults to <code>"DTYPE"</code> and the discriminator type to
